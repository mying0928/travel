const itineraryData = {
    day1: {
        ...
        items: [
            ...
            { time: "傍晚", title: "港邊雙體驗：A-Factory & 睡魔之家", icon: "fa-city", content: { description: "感受青森的兩大魅力：蘋果與睡魔祭。", subsections: [
                ...
                { title: "👹 睡魔之家 WARASSE", description: "步行 2 分鐘即可抵達，常設展示可近距離觀賞睡魔祭的巨型燈籠花車，感受祭典的震撼力。<br>🎬 影像首映 09:30，之後每半小時（10:00 起）撥出一次、每次 10 分鐘；🥁 睡魔祭體驗（囃子演奏）平日場次為 11:10、13:10、15:10（各 20 分鐘）——傍晚才抵達可能錯過現場體驗場次，仍可盡情欣賞常設花車展示。<br><b>門票：</b>成人 620円 | <b>營業時間：</b>09:00-18:00（<span class=\"text-red-600 font-semibold\">⚠️ 重點：</span>最終入館 17:30，廣田神社逛完若已偏晚要抓緊時間過來）" }
    ...
    day3: {
        ...
        highlights: [
            { icon: "fa-person-hiking", text: "奧入瀨溪流三段散策" },
        ...
        items: [
            ...
            { time: "上午", title: "奧入瀨溪流・三段散策", icon: "fa-person-hiking", content: { description: "沿著溪流悠閒散步，欣賞被青苔覆蓋的岩石、清澈的流水與數個風格各異的瀑布，是日本最美的溪流景觀之一。<br><span class=\"text-red-600 font-semibold\">⚠️ 重點：</span>這段路線有交通管制，包車無法直接開進去，司機會在<b>奧入瀨溪流溫泉停車場</b>讓大家下車，在此購票轉搭接駁巴士遊覽，依序安排三個停靠點（三亂之流方向相反、來回要多花 20-30 分鐘，這次不特別安排）：<br><span class=\"text-amber-600 font-semibold\">💡 小提醒：</span>石戶到雲井瀑布這段約 45-50 分鐘的徒步路段建議穿好走的鞋，並攜帶水與輕便雨具，山區天氣說變就變。", subsections: [
                { title: "① 石戶（石ヶ戸）→ 阿修羅之流 → 雲井瀑布", description: "搭接駁巴士抵達石ケ戸後開始徒步：走約 20-25 分鐘抵達阿修羅之流，再繼續走約 25 分鐘抵達雲井瀑布。<br><span class=\"text-red-600 font-semibold\">⚠️ 重點：</span>走到雲井瀑布後，在雲井の滝站牌搭乘接駁巴士前往下一站！" },
                { title: "② 銚子大瀑布", description: "奧入瀨溪流唯一、也是最大的瀑布。因距離較遠改搭接駁巴士抵達，下車走 2 分鐘就能看到，看完直接回站牌搭下一班車即可。" },
                { title: "③ 子之口／十和田神社前／休屋", description: "接續搭乘接駁巴士前往十和田湖畔，可依當下狀況選擇在子之口或十和田神社前提前下車走走。<br><span class=\"text-amber-600 font-semibold\">💡 小提醒：</span>因路線管制，司機需另外開車繞道，約定在<b>休屋停車場</b>會合，完美結束奧入瀨溪流行程！" }
            ], special: { summary: "🗺️ 展開接駁巴士路線圖與平日時刻表（惣辺交差点～子ノ口，涵蓋 9/10 當天）", content: "<p class='text-sm text-slate-600 mb-2'>惣辺交差点到子ノ口這段管制路段，平日建議多利用接駁巴士串聯各站點；時刻表為 9/7(一)-9/11(五) 平日班次，正好涵蓋這次的行程日期，下圖路線圖則標示 00-14 每一站牌與步行距離、所需時間。</p><img src='images/奧入瀨接駁巴士時刻表.png' alt='奧入瀨溪流接駁巴士平日時刻表' class='w-full rounded-lg border border-gray-200 mt-2' loading='lazy'><p class='text-xs text-slate-500 mt-1 text-center'>接駁巴士平日時刻表（9/7-9/11）</p><img src='images/奧入瀨接駁巴士路線圖.png' alt='奧入瀨溪流接駁巴士站牌路線圖' class='w-full rounded-lg border border-gray-200 mt-4' loading='lazy'><p class='text-xs text-slate-500 mt-1 text-center'>接駁巴士站牌路線圖</p><a href='https://www.eco-oirase.com/ja/bus-ship' target='_blank' rel='noopener noreferrer' class='inline-flex items-center gap-1 text-xs text-sky-600 hover:text-sky-800 underline mt-2'><i class='fas fa-link'></i> 官方資訊（eco-oirase.com 接駁巴士・遊覽船）</a>" } } },
    ...
    day5: {
        ...
        items: [
            ...
            { time: "下午", title: "松島灣遊船", icon: "fa-sailboat", content: { description: "松島灣環島觀光船共有兩間遊船公司，「搭船處」都在 Google Map 的「松島湾観光船発着場」，可導航到「松島海岸レストハウス」即購票處，旁邊往海延伸出去的位置就是搭船地點。<br>搭右邊的「松島環島觀光船企業組合」仁王丸コース（大型船），就是現場最右邊的窗口，也是最多人推薦的船班，船程 50 分鐘，路線全長約 17 公里，會經過松島灣必看的「金島」和「仁王島」，也可以看到「景島」、「船入島」。<br>🎫 <span class=\"text-red-600 font-semibold\">⚠️ 重點：</span>從 9:00 最晚 16:00 開船，整點一班船，要提早 15 分鐘到（看最晚一班比較不熱）。購買 KKday「宮城仙台｜日本三大景松島遊船組合套票」可包含船票＋魚餅＋烤牡蠣。" } },
