const itineraryData = {
    day1: {
        ...
        items: [{
            ...
            content: {
                ...
                subsections: [{
                    title: "⛩️ 妙義神社",
                    description: "首先來到寧靜的<strong>妙義神社</strong>，為旅程祈求「勝運」，戰勝所有挑戰！"
                }, {
                    title: "🌸 六義園",
                    description: "漫步至名園<strong>六義園</strong>，欣賞巨大「枝垂櫻」如瀑布般盛開的壯觀景象。"
                }]
            }
        }, {
            time: "11:00 - 14:00",
            ...
            content: {
                ...
                subsections: [{
                    title: "🌳 谷中靈園",
                    description: "穿越<strong>櫻花大道</strong>，欣賞古樹與光影交織的靜謐風景。"
                }, {
                    title: "🌇 夕陽階梯 & 谷中銀座",
                    description: "在經典的<strong>夕陽階梯</strong>拍照後，於<strong>谷中銀座商店街</strong>享用午餐，品嚐<strong>炸肉餅</strong>、<strong>貓尾巴甜甜圈</strong>等排隊美食。🍩"
                }]
            }
        }, {
            time: "14:00 - 17:30",
            ...
            content: {
                ...
                subsections: [{
                    title: "⛩️ 根津神社",
                    description: "散步至<strong>根津神社</strong>，欣賞「乙女稻荷神社」彷彿京都縮影般的千本鳥居。"
                }, {
                    title: "🌸 上野恩賜公園",
                    description: "投入「上野櫻花祭」的熱鬧懷抱！感受被粉紅燈籠海包圍的幸福感，欣賞櫻花樹下的歡樂景象。"
                }]
            }
        }, {
            time: "17:30 - 21:30",
            ...
            content: {
                ...
                subsections: [{
                    title: "🍣 晚餐時間",
                    description: "在阿美橫丁有各式各樣的露天居酒屋、燒肉、迴轉壽司可供選擇。"
                }, {
                    title: "🛍️ 購物行程",
                    description: "餐後前往 24 小時營業的<strong>唐吉訶德</strong>，一站式補齊所有藥妝、零食和伴手禮。"
                }]
            }
        }, {
            time: "21:30 - 22:00",
    ...
    day2: {
        ...
        items: [{
            ...
            icon: "fa-coffee",
            content: {
                description: "☀️ 享用早餐，為充滿文化與活力的一天做好準備！"
            }
        }, {
            time: "09:00 - 09:30",
            title: "出發・前往上野公園",
            icon: "fa-train",
            content: {
                description: "從田端出發，迎接公園的綠意與文化氣息。",
            ...
            content: {
                ...
                subsections: [{
                    ...
                    description: "與可愛的動物們相見歡，特別是人氣明星<strong>熊貓</strong>！(建議停留 2.5-3小時)"
                }, {
                    title: "🌳 公園散策",
                    description: "悠閒參觀金碧輝煌的<strong>上野東照宮</strong>，並在<strong>櫻花大道</strong>與<strong>不忍池</strong>畔享受春日風光。(建議停留 1-1.5小時)"
                }]
            }
        }, {
            time: "13:30 - 15:30",
            ...
            icon: "fa-utensils",
            content: {
                description: "走進上野最熱鬧的露天市集！在這裡可以找到便宜的藥妝、零食，還有知名的<strong>二木菓子</strong>。午餐可以品嚐<strong>海鮮丼飯</strong> 🍣 等道地小吃，感受充滿叫賣聲的下町活力。🛍️",
            ...
            icon: "fa-subway",
            content: {
                description: "從上野的古典氛圍，轉換場景至現代化的東京地標。🏙️",
            ...
            content: {
                ...
                subsections: [{
                    title: "🐧 墨田水族館",
                    description: "位於晴空塔內的都市型水族館，可以近距離觀賞<strong>企鵝</strong>和<strong>海狗</strong>。<br>票價：成人（18歲以上）¥2,500",
                    links: [{
                    ...
                    description: "享受購物樂趣！這裡有超過300家店鋪，從動漫迷必逛的「<strong>寶可夢中心</strong> 👾」、「<strong>吉卜力共和國</strong> 🌳」，到伴手禮首選「<strong>東京芭娜娜</strong> 🍌」限定口味，應有盡有。"
                }]
            }
        }, {
            time: "19:30後",
    ...
    day3: {
        ...
        items: [{
            ...
            icon: "fa-train-tram",
            content: {
                description: "🌉 搭上電車，經由彩虹大橋或地下隧道，向著充滿現代感的人工島前進！🏝️",
            ...
            content: {
                ...
                subsections: [{
                    title: "🗽 富士電視台 & 自由女神像",
                    description: "與<strong>自由女神像</strong>及<strong>彩虹大橋</strong>合影 📸，感受東京灣的開闊，並可參觀<strong>富士電視台</strong>的球體展望室。"
                }, {
                    title: "🤖 DiverCity 廣場 & 獨角獸鋼彈",
                    description: "朝聖實物大的<strong>獨角獸鋼彈</strong>，感受其震撼力，並可逛逛商場內的<strong>鋼彈基地</strong>。"
                }]
            }
        }, {
            time: "13:00 - 13:30",
            ...
            icon: "fa-ship",
            content: {
                description: "悠閒散步至 <strong>お台場海浜公園</strong> 碼頭 🚶‍♀️，準備搭乘水上巴士，從不同的視角欣賞東京。",
            ...
            icon: "fa-user-tie",
            content: {
                description: "抵達淺草碼頭後，前往預約好的和服店，挑選喜愛的花色，由專人協助換裝，變身完成！✨",
            ...
            icon: "fa-person-walking",
            content: {
                description: "🏮 穿著美麗的和服，悠閒地參拜香火鼎盛的<strong>淺草寺</strong>、在掛著巨大燈籠的<strong>雷門</strong>前拍照留念 📸，並在熱鬧的<strong>仲見世商店街</strong>逛街、品嚐<strong>人形燒</strong>等特色小吃 🍡。",
            ...
            icon: "fa-person-walking",
            content: {
                description: "🌙 感受入夜後稍微靜謐的淺草，輕鬆散步至預定的晚餐地點。",
                transport: "步行即可抵達餐廳。"
            }
        }, {
            time: "19:30後",
            ...
            icon: "fa-utensils",
            content: {
                description: "前往<strong>牛たんの檸檬 浅草店</strong>，品嚐美味的厚切牛舌燒肉，為豐富的一天畫下完美句點。😋"
            }
        }]
    },
    day4: {
        ...
        items: [{
            ...
            content: {
                ...
                subsections: [{
                    ...
                    description: "在新宿站購買「<strong>箱根周遊券</strong>」後，搭乘以下任一車種前往「<strong>箱根湯本站</strong>」。",
                    links: [{
                        icon: "fas fa-info-circle",
                        text: "箱根周遊券",
            ...
            icon: "fa-smog",
            content: {
                description: "♨️ 搭乘經典的箱根交通工具，一路攀升至白煙繚繞的火山谷<strong>大涌谷</strong> 🌋。在這裡可以遠眺富士山 🗻，並品嚐延年益壽的「<strong>黑玉子</strong>」溫泉蛋 ⚫。",
            ...
            icon: "fa-sailboat",
            content: {
                description: "🏴‍☠️ 登上華麗的<strong>海賊船</strong> 🚢，在蘆之湖上航行，欣賞湖光山色與遠方的富士山景。巡航時間約 20-30 分鐘。",
            ...
            icon: "fa-utensils",
            content: {
                description: "抵達「元箱根港」後，您可以在湖畔的餐廳享用午餐 🍽️。餐後，步行至湖邊的停車場，尋找拍攝水上「<strong>平和的鳥居</strong>」的經典角度。若時間和體力允許，可再步行約20分鐘至<strong>箱根神社</strong>本殿參拜。⛩️",
            ...
            icon: "fa-store",
            content: {
                description: "回到箱根的門戶「<strong>箱根湯本</strong>」，在熱鬧的商店街上選購伴手禮、品嚐<strong>溫泉饅頭</strong> 🍡，為箱根之旅畫下句點。🎁",
            ...
            content: {
                description: "從 <strong>箱根湯本站</strong> 搭乘 <strong>小田急浪漫特快</strong> 🚆 返回新宿，再轉乘JR山手線回到田端。"
            }
        }]
    },
    day5: {
        ...
        items: [{
            ...
            icon: "fa-mug-hot",
            content: {
                description: "☀️ 美好的一天從早餐開始！在出發前悠閒地享用早餐，為今天的旅程儲備滿滿的能量。"
            }
        }, {
            time: "09:00 - 10:30",
            title: "阿佐谷神明宮・結緣參拜",
            ...
            content: {
                description: "前往以獨特的刺繡御朱印「<strong>神結</strong>」聞名的<strong>阿佐谷神明宮</strong>，為這趟旅程祈求美好的緣分。⛩️",
            ...
            content: {
                description: "回到潮流的中心地帶！與<strong>忠犬八公像</strong>合影 🐕，並在全世界最繁忙的<strong>澀谷十字路口</strong>感受人潮脈動。之後在周邊的百貨或巷弄中尋找美食，享用午餐。🍜",
            ...
            icon: "fa-cat",
            content: {
                description: "探訪新宿東口的熱鬧街區！抬頭尋找「<strong>Cross Shinjuku Vision</strong>」上逼真的巨大3D貓咪 🐈，再步行至隱身於鬧區中的<strong>花園神社</strong>，感受都會中難得的寧靜。⛩️",
            ...
            content: {
                ...
                subsections: [{
                    ...
                    description: "欣賞夜晚更加閃亮的3D貓咪、尋找藏在飯店上方的<strong>哥吉拉頭像</strong> 🦖，感受五光十色的街區活力。"
                }, {
                    title: "🥃 新宿黃金街 (Golden Gai)",
                    description: "最後鑽進由數百家微型酒吧組成的<strong>新宿黃金街</strong>，這裡保留了戰後東京的樣貌，是體驗在地夜生活的絕佳地點。"
                }]
            }
        }, {
            time: "22:00 - 22:30",
    ...
    day6: {
        ...
        items: [{
            ...
            icon: "fa-landmark",
            content: {
                description: "免費參觀<strong>皇居東御苑</strong>的江戶城舊址、<strong>天守台遺跡</strong> 🏯，感受歷史的厚重。<br><strong>[注意]</strong>：每週一、週五固定休園 (若遇假日則順延)。",
            ...
            icon: "fa-leaf",
            content: {
                description: "春天時是東京最著名的賞櫻名所之一 🌸，沿著<strong>千鳥淵公園</strong>的護城河悠閒散步，享受寧靜時光。",
            ...
            icon: "fa-camera",
            content: {
                description: "參拜德川家的靈廟<strong>增上寺</strong>，並從寺廟廣場拍攝以古老寺廟為前景、現代<strong>東京鐵塔</strong>為背景的經典照片。📸",
            ...
            content: {
                description: "登上東京的昭和時代象徵 🗼 <strong>東京鐵塔</strong>，建議登塔欣賞白天、日落至傍晚的景色。",
            ...
            icon: "fa-train-subway",
            content: {
                description: "準備前往晚餐地點，欣賞東京車站的夜景。",
            ...
            content: {
                description: "在 <strong>KITTE</strong> 商場的 B1、5F、6F 餐廳享用晚餐。餐後務必至 6 樓「<strong>屋頂花園</strong>」，免費拍攝<strong>東京車站</strong>紅磚站房的經典夜景。🌃",
            ...
            content: {
                ...
                subsections: [{
                    ...
                    description: "目標是「<strong>Yodobashi Camera (ヨドバシAkiba)</strong>」(營業至 22:00)。<br><strong>交通：</strong>從東京車站搭乘 <strong>JR京濱東北線</strong> 或 <strong>JR山手線</strong> (2 站，約 4 分鐘) 抵達「秋葉原」站。<br><strong>返回田端：</strong>從「秋葉原」站搭乘 <strong>JR山手線</strong> (外回) 直達「田端」站 (約 10-12 分鐘)。"
                }, {
                    title: "【選擇 2：銀座】(藥妝 / 零食 / 雜貨) 🛍️",
                    description: "目標是「<strong>唐吉訶德 (Don Quijote) 銀座本館</strong>」(24 小時營業)。<br><strong>交通：</strong>從東京車站步行 15-20 分鐘，或搭地鐵丸之內線 1 站到「銀座」。<br><strong>返回田端：</strong>從銀座步行至 JR「有樂町」站，搭乘 <strong>JR山手線</strong> (內回) 直達「田端」站 (約 20 分鐘)。"
                }, {
                    title: "【選擇 3：新宿】(感受氛圍 / 綜合) 🌃",
                    description: "目標是新宿東口、<strong>歌舞伎町</strong>周邊、遊戲中心、<strong>唐吉訶德</strong> (24 小時)。<br><strong>交通：</strong>從東京車站搭乘 <strong>JR中央線快速</strong> (約 15 分鐘) 抵達「新宿」站。<br><strong>返回田端：</strong>從「新宿」站搭乘 <strong>JR山手線</strong> (外回) 直達「田端」站 (約 20-22 分鐘)。"
                }]
            }
        }]
    },
    day7: {
        ...
        items: [{
            ...
            icon: "fa-mug-hot",
            content: {
                description: "☀️ 為了準時出發，今天得早點起床！迅速享用早餐，為富士山之旅做好準備。"
            }
        }, {
            time: "07:30 - 09:30",
            title: "啟程出發・奔向富士山",
            icon: "fa-car",
            content: {
                description: "包車司機準時接送，我們從田端出發，沿高速公路直奔富士山區 🚗，準備迎接一整天的絕景！",
            ...
            icon: "fa-seedling",
            content: {
                description: "抵達<strong>大石公園</strong>，這裡是河口湖畔的絕佳觀景點 🏞️。沿著「<strong>花街道</strong>」散步，將富士山與湖景一次捕捉，並可逛逛一旁的自然生活館。",
            ...
            icon: "fa-music",
            content: {
                description: "走進宛如歐洲童話的<strong>音樂與森林博物館</strong> 🏰，欣賞世界級的自動音樂盒演奏。我們將在此悠閒漫步，並在園區的景觀餐廳享用午餐 🍽️。<br><strong>門票：</strong> 成人約 1,800 日圓 (依平假日浮動)。",
            ...
            content: {
                ...
                subsections: [{
                    title: "📸 羅森便利商店",
                    description: "朝聖社群媒體上最火紅的打卡點，在<strong>羅森便利商店</strong>前可以拍下以富士山為背景的完美街景照。"
                }, {
                    title: "🍞 富士山吐司 (Fujisan Shokupan)",
                    description: "接著去排隊購買超可愛的藍白雙色「<strong>富士山吐司</strong>」，無論是自己享用或當伴手禮都很棒！"
                }],
            ...
            icon: "fa-water",
            content: {
                description: "探訪由富士山雪水融化後形成的八個清澈湧泉池 💧。在<strong>忍野八海</strong>欣賞水面倒影與傳統茅草屋構成的日式鄉村風情，還能嚐嚐這裡的<strong>名水豆腐</strong>和<strong>草餅</strong>。",
            ...
            icon: "fa-image",
            content: {
                description: "來到山中湖畔的<strong>平野之濱</strong>，這裡是欣賞「逆富士」的著名景點。在寧靜的湖畔散步 🦢，享受夕陽餘暉灑落富士山的片刻浪漫。",
            ...
            content: {
                description: "本日的完美終點！從遼闊的<strong>山中湖全景台</strong>俯瞰山中湖與雄偉的富士山 🤩，靜靜欣賞從傍晚到日落的壯麗景色。",
    ...
    day8: {
        ...
        choices: [{
            ...
            items: [
                ...
                { time: "09:30 - 10:30", title: "神田明神・動漫聖地巡禮", icon: "fa-torii-gate", content: { description: "參訪守護秋葉原的宏偉神社<strong>神田明神</strong>，這裡也是《Love Live!》等動漫的聖地。您可以在此尋找獨特的「<strong>IT 御守</strong>」。⛩️", transport: "從秋葉原站電氣街口步行約 10 分鐘。" } },
            ...
            items: [
                ...
                { time: "09:30 - 12:00", title: "太陽城水族館・天空的企鵝", icon: "fa-fish", content: { description: "參觀位於<strong>太陽城</strong>頂樓的都市型水族館 🏙️，欣賞可愛的「<strong>天空的企鵝</strong>」在頭頂上的空中水槽游泳 🐧。", transport: "抵達池袋站後，由「東口」出站，沿著Green大通步行約 11 分鐘至「太陽城」。" } },
                ...
                { time: "16:00 - 18:00", title: "陽光60瞭望台・黃昏與夜景", icon: "fa-building-columns", content: { description: "返回<strong>太陽城</strong>，登上 60 樓的「<strong>陽光60瞭望台 (TENBOU-PARK)</strong>」🌳，欣賞東京從黃昏到夜景的壯麗變化 🌇。<br><strong>[注意]</strong>：瞭望台通常開放至 20:00，建議提早前往。" } },
                { time: "18:00 - 19:30", title: "晚餐・拉麵激戰區", icon: "fa-bowl-food", content: { description: "前往池袋東口的拉麵激戰區享用晚餐，例如大名鼎鼎的「<strong>無敵家拉麵</strong>」或「<strong>一蘭拉麵</strong>」🍜。" } },
                { time: "19:30 - 21:30", title: "池袋夜生活・自由探索", icon: "fa-moon", content: {
                    ...
                    subsections: [{
                        ...
                        title: "【選擇 4：購物血拼】 🛍️",
                        description: "在車站附近的「<strong>唐吉訶德</strong>」、「<strong>Bic Camera</strong>」或「<strong>Parco 百貨</strong>」進行最後採買。"
                    }]
                }},
    ...
    day9: {
        ...
        items: [{
            ...
            icon: "fa-gifts",
            content: {
                description: "享用早餐後，這是您查漏補缺的最後機會。可以去前一天沒逛夠的店家，或是前往大型連鎖雜貨店「<strong>驚安的殿堂・唐吉訶德</strong>」一次買齊藥妝、零食和各種有趣的伴手禮。🛍️ 🎁"
            }
        }, {
            time: "13:00後",
            title: "告別的午餐・前往機場",
            ...
            content: {
                description: "在市區享用在日本的最後一餐 🍱，之後返回住處整理行李，準備前往機場，結束愉快的旅程。",
                transport: "從市區搭乘 <strong>Skyliner</strong> 或 <strong>N'EX 成田特快</strong> 🚆 前往成田機場。"
            }
        }]
    }
};